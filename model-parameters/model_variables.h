...
const char* ei_classifier_inferencing_categories[] = { "Circular", "Left_Right", "Still", "Up_Down" };

uint8_t ei_dsp_config_2_axes[] = { 0, 1, 2 };
const uint32_t ei_dsp_config_2_axes_size = 3;
ei_dsp_config_imu_syntiant_t ei_dsp_config_2 = {
    2, // uint32_t blockId
...
const ei_impulse_t impulse_564723_0 = {
    .project_id = 564723,
    .project_owner = "Sandeep Reddy Modugu",
    .project_name = "Sandeep_Reddy-project-1",
    .impulse_id = 1,
    .impulse_name = "Impulse #1",
    .deploy_version = 1,

    .nn_input_frame_size = 608,
...
ei_impulse_handle_t impulse_handle_564723_0 = ei_impulse_handle_t( &impulse_564723_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_564723_0;
